...
class SettingsTest(unittest.TestCase):
    ...
    def test_setting_init(self):
        ...
        stored_coord_offset = self.singleton.get_printer('bj_printer')['coord_offset'].value
    ...
    def test_set_settings(self):
        ...
        self.singleton.clone_printer('bj_printer', 'new_printer')
        old_val = self.singleton.get_printer('new_printer')['coord_offset'].value
        self.singleton.get_printer('new_printer')['coord_offset'].value = modified_coord
