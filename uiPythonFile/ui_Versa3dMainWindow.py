...
class Ui_Versa3dMainWindow(object):
    def setupUi(self, Versa3dMainWindow):
        ...
        self.svg_viewer = QtWidgets.QWidget(self.slice_tab)
        self.svg_viewer.setMinimumSize(QtCore.QSize(310, 0))
        self.svg_viewer.setAutoFillBackground(False)
        self.svg_viewer.setObjectName("svg_viewer")
        self.thicknessLabel = QtWidgets.QLabel(self.svg_viewer)
        ...
        self.horizontalLayout_4.addWidget(self.svg_viewer)
