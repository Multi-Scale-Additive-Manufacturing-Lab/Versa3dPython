...
class Ui_Versa3dMainWindow(object):
    def setupUi(self, Versa3dMainWindow):
        ...
        self.thicknessLabel = QtWidgets.QLabel(self.slice_viewer)
        self.thicknessLabel.setGeometry(QtCore.QRect(180, 0, 121, 20))
        font = QtGui.QFont()
        ...
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.infill_tab)
        ...
        self.systemImage.setGeometry(QtCore.QRect(10, 10, 61, 51))
        self.systemImage.setText("")
        self.systemImage.setObjectName("systemImage")
        self.layoutWidget1 = QtWidgets.QWidget(self.machine_tab)
        self.layoutWidget1.setGeometry(QtCore.QRect(90, 10, 240, 42))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.layoutWidget1)
        self.verticalLayout_4.setContentsMargins(11, 11, 11, 11)
        self.verticalLayout_4.setSpacing(6)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.machineLabel = QtWidgets.QLabel(self.layoutWidget1)
        self.machineLabel.setObjectName("machineLabel")
        self.verticalLayout_4.addWidget(self.machineLabel)
        self.processLabel = QtWidgets.QLabel(self.layoutWidget1)
    ...
    def retranslateUi(self, Versa3dMainWindow):
        ...
        self.thicknessLabel.setText(_translate("Versa3dMainWindow", "Layer Thickness:"))
